# Generated by Django 2.1.5 on 2020-10-22 17:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advAmtPaid', models.CharField(blank=True, max_length=200, null=True)),
                ('location', models.CharField(choices=[('1', 'PARTY HALL'), ('2', 'SWIMMING POOL'), ('3', 'KIDS PLAYING AREA')], max_length=50)),
                ('status', models.CharField(blank=True, choices=[('approve', 'APPROVED'), ('decline', 'DECLINED')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(max_length=200)),
                ('pickupDateTime', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
